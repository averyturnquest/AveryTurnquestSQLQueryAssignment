...
$query = 'SELECT E.customerID, T.emailAddress, T.firstName, T.lastName, E.line1, E.city, E.state, E.zipCode, E.phone FROM `addresses` E
            INNER JOIN `customers` T
            ON E.customerID = T.customerID
            GROUP BY E.customerID, T.emailAddress, T.firstName, T.lastName, E.line1, E.city, E.state, E.zipCode, E.phone';// PUT YOUR SQL QUERY HERE
